...
import machine from "../assets/machine1.webp";
const About = () => {
  return (
    <div className="about-wrapper" id="about">
      ...
      <section className="company-story">
        ...
        <div className="story-image">
          <img src={machine} alt="Oil Pouring" />
        </div>
      </section>
      ...
      <footer className="about-footer">
        ...
        <p>
          With a growing footprint across continents, GoldHarvest Naturals is proud to deliver premium oils to households and industries in India.
        </p>
      </footer>
    </div>
  );
